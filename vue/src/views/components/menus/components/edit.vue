...
<script>
import { getDataTree,edit } from '@/api/menus'
...
export default {
    ...
    methods:{
        currentData(currentData){
            currentData && Object.keys(this.form).forEach(key => this.form[key] = currentData[key]);
        },
        changeType(val){
            this.form.type = val;
        },
        ...
        submit(){
            this.loading = true;
            this.handleSubmit(edit,this.$refs['form'],this,data => {
                this.loading = false;
